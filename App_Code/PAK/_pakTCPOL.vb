    ...
    Public Shared Function InsertData(ByVal Record As SIS.PAK.pakTCPOL) As SIS.PAK.pakTCPOL
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@ItemQuantity", SqlDbType.Decimal, 25, IIf(Record.ItemQuantity = "", Convert.DBNull, Record.ItemQuantity))
          ...
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@ItemPrice", SqlDbType.Decimal, 25, IIf(Record.ItemPrice = "", Convert.DBNull, Record.ItemPrice))
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@ItemAmount", SqlDbType.Decimal, 25, IIf(Record.ItemAmount = "", Convert.DBNull, Record.ItemAmount))
