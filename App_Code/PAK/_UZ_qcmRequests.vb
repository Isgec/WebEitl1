...
Namespace SIS.QCM
  ...
  Partial Public Class qcmRequests
    Public Shared Function qcmSRequestsToBeAttended(ByVal PrimaryKey As String) As List(Of SIS.QCM.qcmRequests)
      Dim aVal() As String = PrimaryKey.Split("|".ToCharArray)
      Dim SerialNo As String = aVal(0)
      Dim QclNo As String = aVal(1)
      ...
      Using Con As SqlConnection = New SqlConnection(SIS.SYS.SQLDatabase.DBCommon.GetConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@SerialNo", SqlDbType.Int, 10, SerialNo)
          SIS.SYS.SQLDatabase.DBCommon.AddDBParameter(Cmd, "@QclNo", SqlDbType.Int, 10, QclNo)
