  ...
  Partial Public Class pakSTCPOLR
    ...
    Public Shared Function ReviseWF(ByVal SerialNo As Int32, ByVal ItemNo As Int32, ByVal UploadNo As Int32) As SIS.PAK.pakSTCPOLR
      ...
      If tmpS.UploadStatusID = pakTCUploadStates.CommentSubmitted Then
        ...
        With xdTmp
          .SerialNo = tmpS.SerialNo
          .ItemNo = tmpS.ItemNo
          .UploadNo = tmpS.UploadNo
          .DocumentID = "VENDOR DOCUMENT"
          .DocumentDescription = "Uploaded By Vendor"
          .DocumentRev = tmpS.RevisionNo
          .ReceiptNo = tmpS.ReceiptNo
          .RevisionNo = tmpS.RevisionNo
          .FileName = "NA"
          .DiskFileName = "NA"
          .ERPDocSerialNo = 1
          .AutoGenerated = True
        ...
        tmpS.SDocSerialNo = xdTmp.DocSerialNo
        tmpS = SIS.PAK.pakSTCPOLR.UpdateData(tmpS)
      End If
      Return tmpS
    End Function
    ...
    Private Shared Sub DistributeInERP(ByVal ReceiptNo As String, ByVal RevisionNo As String)
      ...
      Dim mFileName As String = "REP" & CardNo & "_" & Now.ToString.Replace("/", "").Replace(":", "").Replace(" ", "") & ".xml"
