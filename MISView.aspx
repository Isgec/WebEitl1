...
<body style="font-family:'Courier New'; font-size:12px;">
  ...
  <div class="mis-main">
    Project IDs [ProjectID1,ProjectID2, ....]
    <asp:TextBox ID="F_Projects" runat="server" Width="200px"></asp:TextBox>
    <asp:Button ID="cmdPrint" runat="server" Text="Generate" CssClass="nt-but-primary" />
  </div>
