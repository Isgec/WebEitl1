        ...
        <ContentTemplate>
          <asp:FormView ID="FVediWTmtlH"
            ...
            <EditItemTemplate>
              <div id="frmdiv" class="ui-widget-content minipage">
                <table style="margin: auto; border: solid 1pt lightgrey">
                  <tr>
                    <td class="alignright">
                      <b>
                        <asp:Label ID="L_t_tran" runat="server" ForeColor="#CC6633" Text="Transmittal No. :" /><span style="color: red">*</span></b>
                    </td>
                    <td>
              ...
              <asp:Label runat="server" Font-Bold="true" Font-Size="14px" Text="NOTE: Standard Document in this transmittal will NOT be available for download. Please download/get it from Vault/Design Deptt."></asp:Label>
